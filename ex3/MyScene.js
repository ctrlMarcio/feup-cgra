...
class MyScene extends CGFscene {
    ...
    initMaterials() {
        ...
        // Similar to wood (low specular)
        this.material4 = new CGFappearance(this);
        this.material4.setAmbient(37/255, 26/255, 14/255, 1.0);
        this.material4.setDiffuse(115/255, 77/255, 38/255, 1.0);
        ...
        // Labels and ID's for object selection on MyInterface
        this.materialIDs = {'Red Ambient': 0, 'Red Diffuse': 1, 'Red Specular': 2, 'Kind of wood': 3, 'Custom': 4 };
    }
    display() {
